...
```console
helm install [RELEASE_NAME] nholuongut/prometheus
```
...
- [alertmanager](https://github.com/nholuongut/helm-charts/tree/main/charts/alertmanager)
- [kube-state-metrics](https://github.com/nholuongut/helm-charts/tree/main/charts/kube-state-metrics)
- [prometheus-node-exporter](https://github.com/nholuongut/helm-charts/tree/main/charts/prometheus-node-exporter)
...
```console
helm upgrade [RELEASE_NAME] nholuongut/prometheus --install
```
...
```console
helm upgrade -i prometheus nholuongut/prometheus
```
...
See the [upgrade docs of the prometheus-pushgateway chart](https://github.com/nholuongut/helm-charts/tree/main/charts/prometheus-pushgateway#to-200) to see whats to do, before you upgrade Prometheus!
...
```bash
helm upgrade [RELEASE_NAME] nholuongut/prometheus --version 19.0.0
```

### To 18.0

Version 18.0.0 uses alertmanager service from the [alertmanager chart](https://github.com/nholuongut/helm-charts/tree/main/charts/alertmanager). If you've made some config changes, please check the old `alertmanager` and the new `alertmanager` configuration section in values.yaml for differences.
...
kubectl scale deploy prometheus-server --replicas=0
# Upgrade
helm upgrade [RELEASE_NAME] nholuongut/prometheus --version 16.0.0
```
...
```console
helm show values nholuongut/prometheus
```
...
```console
helm install [RELEASE_NAME] nholuongut/prometheus -f values.yaml -f service1-alert.yaml -f service2-alert.yaml
```
