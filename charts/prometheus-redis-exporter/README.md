...
```console
helm install [RELEASE_NAME] nholuongut/prometheus-redis-exporter
```
...
helm upgrade -i prometheus-redis-exporter nholuongut/prometheus-redis-exporter
```
...
```console
helm show values nholuongut/prometheus-redis-exporter
```
