...
Learn more: <https://github.com/nholuongut/stackdriver_exporter>
...
```console
# Helm 3
$ helm install [RELEASE_NAME] nholuongut/prometheus-stackdriver-exporter --set stackdriver.projectId=google-project-name

# Helm 2
$ helm install --name [RELEASE_NAME] nholuongut/prometheus-stackdriver-exporter --set stackdriver.projectId=google-project-name
```
...
Since chart version 2.0.0, the exporter is configured via flags/arguments instead of environment variables due to a [breaking change in the exporter](https://github.com/nholuongut/stackdriver_exporter/pull/142).
...
```console
# Helm 2
$ helm inspect values nholuongut/prometheus-stackdriver-exporter

# Helm 3
$ helm show values nholuongut/prometheus-stackdriver-exporter
```
