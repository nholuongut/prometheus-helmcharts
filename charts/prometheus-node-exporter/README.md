...
```console
helm install [RELEASE_NAME] nholuongut/prometheus-node-exporter
```
...
```console
helm upgrade [RELEASE_NAME] nholuongut/prometheus-node-exporter --install
```
...
helm upgrade -i prometheus-node-exporter nholuongut/prometheus-node-exporter
```
...
```console
helm show values nholuongut/prometheus-node-exporter
```
