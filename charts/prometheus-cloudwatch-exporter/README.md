...
```console
# Helm 3
$ helm install [RELEASE_NAME] nholuongut/prometheus-cloudwatch-exporter

# Helm 2
$ helm install --name [RELEASE_NAME] nholuongut/prometheus-cloudwatch-exporter
```
...
```console
# Helm 2
$ helm inspect values nholuongut/prometheus-cloudwatch-exporter

# Helm 3
$ helm show values nholuongut/prometheus-cloudwatch-exporter
```
