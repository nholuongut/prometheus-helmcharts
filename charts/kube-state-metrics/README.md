...
Installs the [kube-state-metrics agent](https://github.com/nholuongut/kube-state-metrics).
...
```console
helm install [RELEASE_NAME] nholuongut/kube-state-metrics [flags]
```
...
```console
helm upgrade [RELEASE_NAME] nholuongut/kube-state-metrics [flags]
```

_See [helm upgrade](https://helm.sh/docs/helm/helm_upgrade/) for command documentation._

### Migrating from stable/kube-state-metrics and nholuongut/kube-state-metrics
...
v3.0.0 includes kube-state-metrics v2.0, see the [changelog](https://github.com/nholuongut/kube-state-metrics/blob/release-2.0/CHANGELOG.md) for major changes on the application-side.
...
```console
helm show values nholuongut/kube-state-metrics
```
