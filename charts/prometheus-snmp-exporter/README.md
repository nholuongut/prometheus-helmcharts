...
```console
helm install [RELEASE_NAME] nholuongut/prometheus-snmp-exporter
```
...
```console
# Helm 2
$ helm inspect values nholuongut/prometheus-snmp-exporter

# Helm 3
$ helm show values nholuongut/prometheus-snmp-exporter
```
