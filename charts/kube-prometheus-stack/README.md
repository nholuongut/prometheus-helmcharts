...
```console
helm install [RELEASE_NAME] nholuongut/kube-prometheus-stack
```
...
- [nholuongut/kube-state-metrics](https://github.com/nholuongut/helm-charts/tree/main/charts/kube-state-metrics)
- [nholuongut/prometheus-node-exporter](https://github.com/nholuongut/helm-charts/tree/main/charts/prometheus-node-exporter)
...
```console
helm upgrade [RELEASE_NAME] nholuongut/kube-prometheus-stack
```
...
See [#3548](https://github.com/nholuongut/helm-charts/issues/3548) for more context.
...
helm upgrade -i kube-prometheus-stack nholuongut/kube-prometheus-stack
```
...
```console
helm upgrade [RELEASE_NAME] nholuongut/kube-prometheus-stack --version 7.5.0
```

Then upgrade to 8.x.x

```console
helm upgrade [RELEASE_NAME] nholuongut/kube-prometheus-stack --version [8.x.x]
```
...
```console
helm show values nholuongut/kube-prometheus-stack
```
...
```console
helm upgrade prometheus-operator nholuongut/kube-prometheus-stack -n monitoring --reuse-values --set nameOverride=prometheus-operator
```
